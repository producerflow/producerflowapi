...
public interface MessageRulesOrBuilder extends
   ...
   */
  java.util.List<com.buf.validate.MessageOneofRule> 
      getOneofList();
  /**
   * <pre>
   * `oneof` is a repeated field of type MessageOneofRule that specifies a list of fields
   ...
   * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
   */
  com.buf.validate.MessageOneofRule getOneof(int index);
  /**
   * <pre>
   * `oneof` is a repeated field of type MessageOneofRule that specifies a list of fields
   * of which at most one can be present. If `required` is also specified, then exactly one
   ...
   * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
   */
  java.util.List<? extends com.buf.validate.MessageOneofRuleOrBuilder> 
   ...
   * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
   */
  com.buf.validate.MessageOneofRuleOrBuilder getOneofOrBuilder(
      int index);
}
