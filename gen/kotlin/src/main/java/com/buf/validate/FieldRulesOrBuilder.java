...
public interface FieldRulesOrBuilder extends
   ...
   * @return The float.
   */
  com.buf.validate.FloatRules getFloat();
  /**
   * <pre>
   * Scalar Field Types
   * </pre>
   ...
   * <code>.buf.validate.FloatRules float = 1 [json_name = "float"];</code>
   */
  com.buf.validate.FloatRulesOrBuilder getFloatOrBuilder();
   ...
   * @return The double.
   */
  com.buf.validate.DoubleRules getDouble();
  /**
   * <code>.buf.validate.DoubleRules double = 2 [json_name = "double"];</code>
   */
  com.buf.validate.DoubleRulesOrBuilder getDoubleOrBuilder();
   ...
   * @return The int32.
   */
  com.buf.validate.Int32Rules getInt32();
  /**
   * <code>.buf.validate.Int32Rules int32 = 3 [json_name = "int32"];</code>
   */
  com.buf.validate.Int32RulesOrBuilder getInt32OrBuilder();
   ...
   * @return The int64.
   */
  com.buf.validate.Int64Rules getInt64();
  /**
   * <code>.buf.validate.Int64Rules int64 = 4 [json_name = "int64"];</code>
   */
  com.buf.validate.Int64RulesOrBuilder getInt64OrBuilder();
   ...
   * @return The uint32.
   */
  com.buf.validate.UInt32Rules getUint32();
  /**
   * <code>.buf.validate.UInt32Rules uint32 = 5 [json_name = "uint32"];</code>
   */
  com.buf.validate.UInt32RulesOrBuilder getUint32OrBuilder();
   ...
   * @return The uint64.
   */
  com.buf.validate.UInt64Rules getUint64();
  /**
   * <code>.buf.validate.UInt64Rules uint64 = 6 [json_name = "uint64"];</code>
   */
  com.buf.validate.UInt64RulesOrBuilder getUint64OrBuilder();
   ...
   * @return The sint32.
   */
  com.buf.validate.SInt32Rules getSint32();
  /**
   * <code>.buf.validate.SInt32Rules sint32 = 7 [json_name = "sint32"];</code>
   */
  com.buf.validate.SInt32RulesOrBuilder getSint32OrBuilder();
   ...
   * @return The sint64.
   */
  com.buf.validate.SInt64Rules getSint64();
  /**
   * <code>.buf.validate.SInt64Rules sint64 = 8 [json_name = "sint64"];</code>
   */
  com.buf.validate.SInt64RulesOrBuilder getSint64OrBuilder();
   ...
   * @return The fixed32.
   */
  com.buf.validate.Fixed32Rules getFixed32();
  /**
   * <code>.buf.validate.Fixed32Rules fixed32 = 9 [json_name = "fixed32"];</code>
   */
  com.buf.validate.Fixed32RulesOrBuilder getFixed32OrBuilder();
   ...
   * @return The fixed64.
   */
  com.buf.validate.Fixed64Rules getFixed64();
  /**
   * <code>.buf.validate.Fixed64Rules fixed64 = 10 [json_name = "fixed64"];</code>
   */
  com.buf.validate.Fixed64RulesOrBuilder getFixed64OrBuilder();
   ...
   * @return The sfixed32.
   */
  com.buf.validate.SFixed32Rules getSfixed32();
  /**
   * <code>.buf.validate.SFixed32Rules sfixed32 = 11 [json_name = "sfixed32"];</code>
   */
  com.buf.validate.SFixed32RulesOrBuilder getSfixed32OrBuilder();
   ...
   * @return The sfixed64.
   */
  com.buf.validate.SFixed64Rules getSfixed64();
  /**
   * <code>.buf.validate.SFixed64Rules sfixed64 = 12 [json_name = "sfixed64"];</code>
   */
  com.buf.validate.SFixed64RulesOrBuilder getSfixed64OrBuilder();
   ...
   * @return The bool.
   */
  com.buf.validate.BoolRules getBool();
  /**
   * <code>.buf.validate.BoolRules bool = 13 [json_name = "bool"];</code>
   */
  com.buf.validate.BoolRulesOrBuilder getBoolOrBuilder();
   ...
   * @return The string.
   */
  com.buf.validate.StringRules getString();
  /**
   * <code>.buf.validate.StringRules string = 14 [json_name = "string"];</code>
   */
  com.buf.validate.StringRulesOrBuilder getStringOrBuilder();
   ...
   * @return The bytes.
   */
  com.buf.validate.BytesRules getBytes();
  /**
   * <code>.buf.validate.BytesRules bytes = 15 [json_name = "bytes"];</code>
   */
  com.buf.validate.BytesRulesOrBuilder getBytesOrBuilder();
   ...
   * @return The enum.
   */
  com.buf.validate.EnumRules getEnum();
  /**
   * <pre>
   * Complex Field Types
   * </pre>
   ...
   * <code>.buf.validate.EnumRules enum = 16 [json_name = "enum"];</code>
   */
  com.buf.validate.EnumRulesOrBuilder getEnumOrBuilder();
   ...
   * @return The repeated.
   */
  com.buf.validate.RepeatedRules getRepeated();
  /**
   * <code>.buf.validate.RepeatedRules repeated = 18 [json_name = "repeated"];</code>
   */
  com.buf.validate.RepeatedRulesOrBuilder getRepeatedOrBuilder();
   ...
   * @return The map.
   */
  com.buf.validate.MapRules getMap();
  /**
   * <code>.buf.validate.MapRules map = 19 [json_name = "map"];</code>
   */
  com.buf.validate.MapRulesOrBuilder getMapOrBuilder();
   ...
   * @return The any.
   */
  com.buf.validate.AnyRules getAny();
  /**
   * <pre>
   * Well-Known Field Types
   * </pre>
   ...
   * <code>.buf.validate.AnyRules any = 20 [json_name = "any"];</code>
   */
  com.buf.validate.AnyRulesOrBuilder getAnyOrBuilder();
   ...
   * @return The duration.
   */
  com.buf.validate.DurationRules getDuration();
  /**
   * <code>.buf.validate.DurationRules duration = 21 [json_name = "duration"];</code>
   */
  com.buf.validate.DurationRulesOrBuilder getDurationOrBuilder();
   ...
   */
  com.buf.validate.TimestampRules getTimestamp();
  /**
   * <code>.buf.validate.TimestampRules timestamp = 22 [json_name = "timestamp"];</code>
   */
  com.buf.validate.TimestampRulesOrBuilder getTimestampOrBuilder();

  com.buf.validate.FieldRules.TypeCase getTypeCase();
}
