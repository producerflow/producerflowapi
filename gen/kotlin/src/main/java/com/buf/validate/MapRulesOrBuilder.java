...
public interface MapRulesOrBuilder extends
   ...
   * @return The keys.
   */
  com.buf.validate.FieldRules getKeys();
  /**
   * <pre>
   * Specifies the rules to be applied to each key in the field.
   *
   ...
   * <code>optional .buf.validate.FieldRules keys = 4 [json_name = "keys"];</code>
   */
  com.buf.validate.FieldRulesOrBuilder getKeysOrBuilder();
   ...
   * @return The values.
   */
  com.buf.validate.FieldRules getValues();
  /**
   * <pre>
   * Specifies the rules to be applied to the value of each key in the
   * field. Message values will still have their validations evaluated unless
   ...
   * <code>optional .buf.validate.FieldRules values = 5 [json_name = "values"];</code>
   */
  com.buf.validate.FieldRulesOrBuilder getValuesOrBuilder();
}
