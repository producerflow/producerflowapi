...
public class TestingServiceClient(
   ...
   */
  override suspend fun deleteAgency(request: DeleteAgencyRequest, headers: Headers): ResponseMessage<DeleteAgencyResponse> = client.unary(
    request,
    headers,
    MethodSpec(
    "producerflow.testing.v1.TestingService/DeleteAgency",
      com.producerflow.testing.v1.DeleteAgencyRequest::class,
      com.producerflow.testing.v1.DeleteAgencyResponse::class,
      StreamType.UNARY,
    ),
  )
   ...
   *  - PERMISSION_DENIED: the call was made outside dev/UAT (e.g. production).
   */
  override fun deleteAgencyBlocking(request: DeleteAgencyRequest, headers: Headers): UnaryBlockingCall<DeleteAgencyResponse> = client.unaryBlocking(
    request,
    headers,
    MethodSpec(
    "producerflow.testing.v1.TestingService/DeleteAgency",
   ...
   *  - PERMISSION_DENIED: the call was made outside dev/UAT (e.g. production).
   */
  override suspend fun deleteAppointment(request: DeleteAppointmentRequest, headers: Headers): ResponseMessage<DeleteAppointmentResponse> = client.unary(
    request,
    headers,
    MethodSpec(
    "producerflow.testing.v1.TestingService/DeleteAppointment",
      com.producerflow.testing.v1.DeleteAppointmentRequest::class,
      com.producerflow.testing.v1.DeleteAppointmentResponse::class,
      StreamType.UNARY,
    ),
  )
   ...
   *  - PERMISSION_DENIED: the call was made outside dev/UAT (e.g. production).
   */
  override fun deleteAppointmentBlocking(request: DeleteAppointmentRequest, headers: Headers): UnaryBlockingCall<DeleteAppointmentResponse> = client.unaryBlocking(
    request,
    headers,
    MethodSpec(
    "producerflow.testing.v1.TestingService/DeleteAppointment",
