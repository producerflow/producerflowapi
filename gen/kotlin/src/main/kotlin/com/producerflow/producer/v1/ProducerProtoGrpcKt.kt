...
public object ProducerServiceGrpcKt {
  ...
  public val getContactMethod: MethodDescriptor<GetContactRequest, GetContactResponse>
    @JvmStatic
    get() = ProducerServiceGrpc.getGetContactMethod()
  ...
  public class ProducerServiceCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    public suspend fun getContact(request: GetContactRequest, headers: Metadata = Metadata()): GetContactResponse = unaryRpc(
      channel,
      ProducerServiceGrpc.getGetContactMethod(),
      request,
      callOptions,
      headers
    )
  ...
  public abstract class ProducerServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for producerflow.producer.v1.ProducerService.GetContact.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC will fail
     * with status `Status.CANCELLED`.  If this method fails for any other reason, the RPC will
     ...
     * @param request The request from the client.
     */
    public open suspend fun getContact(request: GetContactRequest): GetContactResponse = throw StatusException(UNIMPLEMENTED.withDescription("Method producerflow.producer.v1.ProducerService.GetContact is unimplemented"))
    ...
    final override fun bindService(): ServerServiceDefinition = builder(getServiceDescriptor())
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = ProducerServiceGrpc.getGetContactMethod(),
