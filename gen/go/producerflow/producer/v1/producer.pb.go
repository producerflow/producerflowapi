...
func (NewAgencyRequest_Agency_BankAccount_AccountType) EnumDescriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 1, 0}
}
...
func (NewAgencyRequest_Agency_PointOfContact_CommunicationRole) EnumDescriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 4, 0}
}
...
type CreateProducerOnboardingLinkRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional agency ID for which the producer will be onboarded
	AgencyId *string `protobuf:"bytes,1,opt,name=agency_id,json=agencyId,proto3,oneof" json:"agency_id,omitempty"`
	// Optional NPN to pre-fill in the onboarding form
	Npn           *string `protobuf:"bytes,2,opt,name=npn,proto3,oneof" json:"npn,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateProducerOnboardingLinkRequest) GetNpn() string {
	if x != nil && x.Npn != nil {
		return *x.Npn
	}
	return ""
...
func (*NewAgencyRequest_Agency_Principal) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
func (*NewAgencyRequest_Agency_BankAccount) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 1}
}
...
func (*NewAgencyRequest_Agency_EOInfo) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 2}
}
...
func (*NewAgencyRequest_Agency_BusinessHours) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 3}
}
...
func (*NewAgencyRequest_Agency_PointOfContact) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 4}
}
...
func (*NewAgencyRequest_Agency_BusinessHours_BusinessHour) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{5, 0, 3, 0}
}
...
func (*GetProducerRequest_ProducerNPNLookup) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{7, 1}
}
...
func (*GetProducerRequest_EmailLookup) Descriptor() ([]byte, []int) {
	return file_producerflow_producer_v1_producer_proto_rawDescGZIP(), []int{7, 2}
}
...
const file_producerflow_producer_v1_producer_proto_rawDesc = "" +
	...
	"#CreateProducerOnboardingLinkRequest\x12 \n" +
	"\tagency_id\x18\x01 \x01(\tH\x00R\bagencyId\x88\x01\x01\x12 \n" +
	"\x03npn\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18\n" +
	"H\x01R\x03npn\x88\x01\x01B\f\n" +
	"\n" +
	"_agency_idB\x06\n" +
	"\x04_npn\"M\n" +
...
var file_producerflow_producer_v1_producer_proto_msgTypes = make([]protoimpl.MessageInfo, 113)
var file_producerflow_producer_v1_producer_proto_goTypes = []any{
	...
	(*CreateProducerOnboardingLinkResponse)(nil),                  // 11: producerflow.producer.v1.CreateProducerOnboardingLinkResponse
	(*NewAgencyRequest)(nil),                                      // 12: producerflow.producer.v1.NewAgencyRequest
	(*NewAgencyResponse)(nil),                                     // 13: producerflow.producer.v1.NewAgencyResponse
	(*GetProducerRequest)(nil),                                    // 14: producerflow.producer.v1.GetProducerRequest
	(*GetProducerResponse)(nil),                                   // 15: producerflow.producer.v1.GetProducerResponse
	(*GetAgencyAndProducersRequest)(nil),                          // 16: producerflow.producer.v1.GetAgencyAndProducersRequest
	(*GetAgencyAndProducersResponse)(nil),                         // 17: producerflow.producer.v1.GetAgencyAndProducersResponse
	(*GetAgencyFilesRequest)(nil),                                 // 18: producerflow.producer.v1.GetAgencyFilesRequest
	(*GetAgencyFilesResponse)(nil),                                // 19: producerflow.producer.v1.GetAgencyFilesResponse
	(*UpdateProducerRequest)(nil),                                 // 20: producerflow.producer.v1.UpdateProducerRequest
	(*UpdateProducerResponse)(nil),                                // 21: producerflow.producer.v1.UpdateProducerResponse
	(*ListNewProducersRequest)(nil),                               // 22: producerflow.producer.v1.ListNewProducersRequest
	(*ListNewProducersResponse)(nil),                              // 23: producerflow.producer.v1.ListNewProducersResponse
	(*ApproveProducerRequest)(nil),                                // 24: producerflow.producer.v1.ApproveProducerRequest
	(*ApproveProducerResponse)(nil),                               // 25: producerflow.producer.v1.ApproveProducerResponse
	(*RejectProducerRequest)(nil),                                 // 26: producerflow.producer.v1.RejectProducerRequest
	(*RejectProducerResponse)(nil),                                // 27: producerflow.producer.v1.RejectProducerResponse
	...
	(*ListOrganizationsRequest)(nil),                              // 60: producerflow.producer.v1.ListOrganizationsRequest
	(*Organization)(nil),                                          // 61: producerflow.producer.v1.Organization
	(*ListOrganizationsResponse)(nil),                             // 62: producerflow.producer.v1.ListOrganizationsResponse
	(*CreateProducerUploadURLRequest)(nil),                        // 63: producerflow.producer.v1.CreateProducerUploadURLRequest
	(*CreateProducerUploadURLResponse)(nil),                       // 64: producerflow.producer.v1.CreateProducerUploadURLResponse
	(*Location)(nil),                                              // 65: producerflow.producer.v1.Location
	(*AddAgencyLocationsRequest)(nil),                             // 66: producerflow.producer.v1.AddAgencyLocationsRequest
	(*LocationInput)(nil),                                         // 67: producerflow.producer.v1.LocationInput
	(*AddAgencyLocationsResponse)(nil),                            // 68: producerflow.producer.v1.AddAgencyLocationsResponse
	(*RemoveAgencyLocationsRequest)(nil),                          // 69: producerflow.producer.v1.RemoveAgencyLocationsRequest
	(*RemoveAgencyLocationsResponse)(nil),                         // 70: producerflow.producer.v1.RemoveAgencyLocationsResponse
	(*ListAgencyLocationsRequest)(nil),                            // 71: producerflow.producer.v1.ListAgencyLocationsRequest
	(*ListAgencyLocationsResponse)(nil),                           // 72: producerflow.producer.v1.ListAgencyLocationsResponse
	(*UpdateAgencyLocationRequest)(nil),                           // 73: producerflow.producer.v1.UpdateAgencyLocationRequest
	(*UpdateAgencyLocationResponse)(nil),                          // 74: producerflow.producer.v1.UpdateAgencyLocationResponse
	(*AssignProducerToLocationsRequest)(nil),                      // 75: producerflow.producer.v1.AssignProducerToLocationsRequest
	(*AssignProducerToLocationsResponse)(nil),                     // 76: producerflow.producer.v1.AssignProducerToLocationsResponse
	(*UnassignProducerFromLocationsRequest)(nil),                  // 77: producerflow.producer.v1.UnassignProducerFromLocationsRequest
	(*UnassignProducerFromLocationsResponse)(nil),                 // 78: producerflow.producer.v1.UnassignProducerFromLocationsResponse
	(*CreateAgencyOnboardingURLRequest_Agency)(nil),               // 79: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency
	(*CreateAgencyOnboardingURLRequest_Agency_Principal)(nil),     // 80: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.Principal
	(*NewAgencyRequest_Agency)(nil),                               // 81: producerflow.producer.v1.NewAgencyRequest.Agency
	(*NewAgencyRequest_Agency_Principal)(nil),                     // 82: producerflow.producer.v1.NewAgencyRequest.Agency.Principal
	(*NewAgencyRequest_Agency_BankAccount)(nil),                   // 83: producerflow.producer.v1.NewAgencyRequest.Agency.BankAccount
	(*NewAgencyRequest_Agency_EOInfo)(nil),                        // 84: producerflow.producer.v1.NewAgencyRequest.Agency.EOInfo
	(*NewAgencyRequest_Agency_BusinessHours)(nil),                 // 85: producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours
	(*NewAgencyRequest_Agency_PointOfContact)(nil),                // 86: producerflow.producer.v1.NewAgencyRequest.Agency.PointOfContact
	(*NewAgencyRequest_Agency_BusinessHours_BusinessHour)(nil),    // 87: producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours.BusinessHour
	(*GetProducerRequest_ProducerIDLookup)(nil),                   // 88: producerflow.producer.v1.GetProducerRequest.ProducerIDLookup
	(*GetProducerRequest_ProducerNPNLookup)(nil),                  // 89: producerflow.producer.v1.GetProducerRequest.ProducerNPNLookup
	(*GetProducerRequest_EmailLookup)(nil),                        // 90: producerflow.producer.v1.GetProducerRequest.EmailLookup
	(*UpdateProducerRequest_Producer)(nil),                        // 91: producerflow.producer.v1.UpdateProducerRequest.Producer
	(*Agency_AgencyInfo)(nil),                                     // 92: producerflow.producer.v1.Agency.AgencyInfo
	(*Agency_Address)(nil),                                        // 93: producerflow.producer.v1.Agency.Address
	(*Agency_BankAccount)(nil),                                    // 94: producerflow.producer.v1.Agency.BankAccount
	(*Agency_EOInfo)(nil),                                         // 95: producerflow.producer.v1.Agency.EOInfo
	(*Agency_Principal)(nil),                                      // 96: producerflow.producer.v1.Agency.Principal
	(*Agency_IvansAccount)(nil),                                   // 97: producerflow.producer.v1.Agency.IvansAccount
	(*Agency_BusinessHours)(nil),                                  // 98: producerflow.producer.v1.Agency.BusinessHours
	(*Agency_NIPR)(nil),                                           // 99: producerflow.producer.v1.Agency.NIPR
	(*Agency_BusinessHours_BusinessHour)(nil),                     // 100: producerflow.producer.v1.Agency.BusinessHours.BusinessHour
	(*Agency_NIPR_Biographic)(nil),                                // 101: producerflow.producer.v1.Agency.NIPR.Biographic
	(*Agency_NIPR_Address)(nil),                                   // 102: producerflow.producer.v1.Agency.NIPR.Address
	(*Agency_NIPR_License)(nil),                                   // 103: producerflow.producer.v1.Agency.NIPR.License
	(*Agency_NIPR_RegulatoryInfo)(nil),                            // 104: producerflow.producer.v1.Agency.NIPR.RegulatoryInfo
	(*Agency_NIPR_Appointment)(nil),                               // 105: producerflow.producer.v1.Agency.NIPR.Appointment
	(*Agency_NIPR_License_LineOfAuthority)(nil),                   // 106: producerflow.producer.v1.Agency.NIPR.License.LineOfAuthority
	(*Agency_NIPR_RegulatoryInfo_RegulatoryAction)(nil),           // 107: producerflow.producer.v1.Agency.NIPR.RegulatoryInfo.RegulatoryAction
	(*Producer_Agency)(nil),                                       // 108: producerflow.producer.v1.Producer.Agency
	(*Producer_NIPR)(nil),                                         // 109: producerflow.producer.v1.Producer.NIPR
	(*Producer_Address)(nil),                                      // 110: producerflow.producer.v1.Producer.Address
	(*Producer_NIPR_License)(nil),                                 // 111: producerflow.producer.v1.Producer.NIPR.License
	(*Producer_NIPR_Biographic)(nil),                              // 112: producerflow.producer.v1.Producer.NIPR.Biographic
	(*Producer_NIPR_ProducerRegulatoryInfo)(nil),                  // 113: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo
	(*Producer_NIPR_Appointment)(nil),                             // 114: producerflow.producer.v1.Producer.NIPR.Appointment
	(*Producer_NIPR_License_LineOfAuthority)(nil),                 // 115: producerflow.producer.v1.Producer.NIPR.License.LineOfAuthority
	(*Producer_NIPR_ProducerRegulatoryInfo_RegulatoryAction)(nil), // 116: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryAction
	nil,                           // 117: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryActionsByStateEntry
	(*NewProducer_Address)(nil),   // 118: producerflow.producer.v1.NewProducer.Address
	(*NewContact_Address)(nil),    // 119: producerflow.producer.v1.NewContact.Address
	(*timestamppb.Timestamp)(nil), // 120: google.protobuf.Timestamp
	(dayofweek.DayOfWeek)(0),      // 121: google.type.DayOfWeek
	(*timeofday.TimeOfDay)(nil),   // 122: google.type.TimeOfDay
}
var file_producerflow_producer_v1_producer_proto_depIdxs = []int32{
	79,  // 0: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.agency:type_name -> producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency
	81,  // 1: producerflow.producer.v1.NewAgencyRequest.agency:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency
	88,  // 2: producerflow.producer.v1.GetProducerRequest.producer_id_lookup:type_name -> producerflow.producer.v1.GetProducerRequest.ProducerIDLookup
	89,  // 3: producerflow.producer.v1.GetProducerRequest.npn_lookup:type_name -> producerflow.producer.v1.GetProducerRequest.ProducerNPNLookup
	90,  // 4: producerflow.producer.v1.GetProducerRequest.email_lookup:type_name -> producerflow.producer.v1.GetProducerRequest.EmailLookup
	29,  // 5: producerflow.producer.v1.GetProducerResponse.producer:type_name -> producerflow.producer.v1.Producer
	28,  // 6: producerflow.producer.v1.GetAgencyAndProducersResponse.agency:type_name -> producerflow.producer.v1.Agency
	29,  // 7: producerflow.producer.v1.GetAgencyAndProducersResponse.producers:type_name -> producerflow.producer.v1.Producer
	91,  // 8: producerflow.producer.v1.UpdateProducerRequest.producer:type_name -> producerflow.producer.v1.UpdateProducerRequest.Producer
	29,  // 9: producerflow.producer.v1.ListNewProducersResponse.new_producers:type_name -> producerflow.producer.v1.Producer
	92,  // 10: producerflow.producer.v1.Agency.agency_info:type_name -> producerflow.producer.v1.Agency.AgencyInfo
	93,  // 11: producerflow.producer.v1.Agency.physical_address:type_name -> producerflow.producer.v1.Agency.Address
	93,  // 12: producerflow.producer.v1.Agency.mailing_address:type_name -> producerflow.producer.v1.Agency.Address
	93,  // 13: producerflow.producer.v1.Agency.invoicing_address:type_name -> producerflow.producer.v1.Agency.Address
	94,  // 14: producerflow.producer.v1.Agency.bank_account:type_name -> producerflow.producer.v1.Agency.BankAccount
	95,  // 15: producerflow.producer.v1.Agency.eo_info:type_name -> producerflow.producer.v1.Agency.EOInfo
	96,  // 16: producerflow.producer.v1.Agency.principal:type_name -> producerflow.producer.v1.Agency.Principal
	97,  // 17: producerflow.producer.v1.Agency.ivans_account:type_name -> producerflow.producer.v1.Agency.IvansAccount
	98,  // 18: producerflow.producer.v1.Agency.business_hours:type_name -> producerflow.producer.v1.Agency.BusinessHours
	99,  // 19: producerflow.producer.v1.Agency.nipr:type_name -> producerflow.producer.v1.Agency.NIPR
	65,  // 20: producerflow.producer.v1.Agency.locations:type_name -> producerflow.producer.v1.Location
	108, // 21: producerflow.producer.v1.Producer.agency:type_name -> producerflow.producer.v1.Producer.Agency
	109, // 22: producerflow.producer.v1.Producer.nipr:type_name -> producerflow.producer.v1.Producer.NIPR
	1,   // 23: producerflow.producer.v1.Producer.onboarding_status:type_name -> producerflow.producer.v1.ProducerOnboardingState
	110, // 24: producerflow.producer.v1.Producer.address:type_name -> producerflow.producer.v1.Producer.Address
	65,  // 25: producerflow.producer.v1.Producer.locations:type_name -> producerflow.producer.v1.Location
	118, // 26: producerflow.producer.v1.NewProducer.mailing_address:type_name -> producerflow.producer.v1.NewProducer.Address
	30,  // 27: producerflow.producer.v1.NewProducerRequest.producer:type_name -> producerflow.producer.v1.NewProducer
	30,  // 28: producerflow.producer.v1.NewProducersRequest.producers:type_name -> producerflow.producer.v1.NewProducer
	119, // 29: producerflow.producer.v1.NewContact.address:type_name -> producerflow.producer.v1.NewContact.Address
	35,  // 30: producerflow.producer.v1.NewContactRequest.contact:type_name -> producerflow.producer.v1.NewContact
	35,  // 31: producerflow.producer.v1.NewContactsRequest.contacts:type_name -> producerflow.producer.v1.NewContact
	61,  // 32: producerflow.producer.v1.ListOrganizationsResponse.organizations:type_name -> producerflow.producer.v1.Organization
	7,   // 33: producerflow.producer.v1.Location.address:type_name -> producerflow.producer.v1.Address
	67,  // 34: producerflow.producer.v1.AddAgencyLocationsRequest.locations:type_name -> producerflow.producer.v1.LocationInput
	7,   // 35: producerflow.producer.v1.LocationInput.address:type_name -> producerflow.producer.v1.Address
	65,  // 36: producerflow.producer.v1.ListAgencyLocationsResponse.locations:type_name -> producerflow.producer.v1.Location
	7,   // 37: producerflow.producer.v1.UpdateAgencyLocationRequest.address:type_name -> producerflow.producer.v1.Address
	65,  // 38: producerflow.producer.v1.UpdateAgencyLocationResponse.location:type_name -> producerflow.producer.v1.Location
	0,   // 39: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.entity_type:type_name -> producerflow.producer.v1.EntityType
	7,   // 40: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.mailing_address:type_name -> producerflow.producer.v1.Address
	7,   // 41: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.physical_address:type_name -> producerflow.producer.v1.Address
	7,   // 42: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.invoicing_address:type_name -> producerflow.producer.v1.Address
	80,  // 43: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.principal:type_name -> producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.Principal
	7,   // 44: producerflow.producer.v1.CreateAgencyOnboardingURLRequest.Agency.Principal.address:type_name -> producerflow.producer.v1.Address
	82,  // 45: producerflow.producer.v1.NewAgencyRequest.Agency.principal:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.Principal
	83,  // 46: producerflow.producer.v1.NewAgencyRequest.Agency.bank_account:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.BankAccount
	84,  // 47: producerflow.producer.v1.NewAgencyRequest.Agency.eo_info:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.EOInfo
	85,  // 48: producerflow.producer.v1.NewAgencyRequest.Agency.business_hours:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours
	30,  // 49: producerflow.producer.v1.NewAgencyRequest.Agency.producers:type_name -> producerflow.producer.v1.NewProducer
	86,  // 50: producerflow.producer.v1.NewAgencyRequest.Agency.points_of_contact:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.PointOfContact
	0,   // 51: producerflow.producer.v1.NewAgencyRequest.Agency.entity_type:type_name -> producerflow.producer.v1.EntityType
	7,   // 52: producerflow.producer.v1.NewAgencyRequest.Agency.mailing_address:type_name -> producerflow.producer.v1.Address
	7,   // 53: producerflow.producer.v1.NewAgencyRequest.Agency.physical_address:type_name -> producerflow.producer.v1.Address
	7,   // 54: producerflow.producer.v1.NewAgencyRequest.Agency.invoicing_address:type_name -> producerflow.producer.v1.Address
	67,  // 55: producerflow.producer.v1.NewAgencyRequest.Agency.locations:type_name -> producerflow.producer.v1.LocationInput
	2,   // 56: producerflow.producer.v1.NewAgencyRequest.Agency.BankAccount.account_type:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.BankAccount.AccountType
	120, // 57: producerflow.producer.v1.NewAgencyRequest.Agency.EOInfo.expiration_date:type_name -> google.protobuf.Timestamp
	120, // 58: producerflow.producer.v1.NewAgencyRequest.Agency.EOInfo.effective_date:type_name -> google.protobuf.Timestamp
	87,  // 59: producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours.business_hours:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours.BusinessHour
	3,   // 60: producerflow.producer.v1.NewAgencyRequest.Agency.PointOfContact.role:type_name -> producerflow.producer.v1.NewAgencyRequest.Agency.PointOfContact.CommunicationRole
	121, // 61: producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours.BusinessHour.week_days:type_name -> google.type.DayOfWeek
	122, // 62: producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours.BusinessHour.opening_time:type_name -> google.type.TimeOfDay
	122, // 63: producerflow.producer.v1.NewAgencyRequest.Agency.BusinessHours.BusinessHour.closing_time:type_name -> google.type.TimeOfDay
	4,   // 64: producerflow.producer.v1.Agency.BankAccount.account_type:type_name -> producerflow.producer.v1.Agency.BankAccount.AccountType
	120, // 65: producerflow.producer.v1.Agency.EOInfo.expiration_date:type_name -> google.protobuf.Timestamp
	120, // 66: producerflow.producer.v1.Agency.EOInfo.effective_date:type_name -> google.protobuf.Timestamp
	93,  // 67: producerflow.producer.v1.Agency.Principal.address:type_name -> producerflow.producer.v1.Agency.Address
	100, // 68: producerflow.producer.v1.Agency.BusinessHours.business_hours:type_name -> producerflow.producer.v1.Agency.BusinessHours.BusinessHour
	101, // 69: producerflow.producer.v1.Agency.NIPR.biographic:type_name -> producerflow.producer.v1.Agency.NIPR.Biographic
	102, // 70: producerflow.producer.v1.Agency.NIPR.addresses:type_name -> producerflow.producer.v1.Agency.NIPR.Address
	103, // 71: producerflow.producer.v1.Agency.NIPR.licenses:type_name -> producerflow.producer.v1.Agency.NIPR.License
	104, // 72: producerflow.producer.v1.Agency.NIPR.regulatory_info:type_name -> producerflow.producer.v1.Agency.NIPR.RegulatoryInfo
	105, // 73: producerflow.producer.v1.Agency.NIPR.appointments:type_name -> producerflow.producer.v1.Agency.NIPR.Appointment
	121, // 74: producerflow.producer.v1.Agency.BusinessHours.BusinessHour.week_days:type_name -> google.type.DayOfWeek
	122, // 75: producerflow.producer.v1.Agency.BusinessHours.BusinessHour.opening_time:type_name -> google.type.TimeOfDay
	122, // 76: producerflow.producer.v1.Agency.BusinessHours.BusinessHour.closing_time:type_name -> google.type.TimeOfDay
	120, // 77: producerflow.producer.v1.Agency.NIPR.Biographic.updated_at:type_name -> google.protobuf.Timestamp
	120, // 78: producerflow.producer.v1.Agency.NIPR.Address.date_updated:type_name -> google.protobuf.Timestamp
	120, // 79: producerflow.producer.v1.Agency.NIPR.Address.updated_at:type_name -> google.protobuf.Timestamp
	5,   // 80: producerflow.producer.v1.Agency.NIPR.License.status:type_name -> producerflow.producer.v1.Agency.NIPR.License.LicenseStatus
	120, // 81: producerflow.producer.v1.Agency.NIPR.License.expiration_date:type_name -> google.protobuf.Timestamp
	120, // 82: producerflow.producer.v1.Agency.NIPR.License.issue_date:type_name -> google.protobuf.Timestamp
	120, // 83: producerflow.producer.v1.Agency.NIPR.License.update_date:type_name -> google.protobuf.Timestamp
	120, // 84: producerflow.producer.v1.Agency.NIPR.License.updated_at:type_name -> google.protobuf.Timestamp
	106, // 85: producerflow.producer.v1.Agency.NIPR.License.lines_of_authority:type_name -> producerflow.producer.v1.Agency.NIPR.License.LineOfAuthority
	107, // 86: producerflow.producer.v1.Agency.NIPR.RegulatoryInfo.regulatory_actions:type_name -> producerflow.producer.v1.Agency.NIPR.RegulatoryInfo.RegulatoryAction
	120, // 87: producerflow.producer.v1.Agency.NIPR.Appointment.status_reason_date:type_name -> google.protobuf.Timestamp
	120, // 88: producerflow.producer.v1.Agency.NIPR.Appointment.appointment_renewal_date:type_name -> google.protobuf.Timestamp
	120, // 89: producerflow.producer.v1.Agency.NIPR.License.LineOfAuthority.issue_date:type_name -> google.protobuf.Timestamp
	120, // 90: producerflow.producer.v1.Agency.NIPR.RegulatoryInfo.RegulatoryAction.date_of_action:type_name -> google.protobuf.Timestamp
	120, // 91: producerflow.producer.v1.Agency.NIPR.RegulatoryInfo.RegulatoryAction.effective_date:type_name -> google.protobuf.Timestamp
	120, // 92: producerflow.producer.v1.Agency.NIPR.RegulatoryInfo.RegulatoryAction.enter_date:type_name -> google.protobuf.Timestamp
	111, // 93: producerflow.producer.v1.Producer.NIPR.licenses:type_name -> producerflow.producer.v1.Producer.NIPR.License
	112, // 94: producerflow.producer.v1.Producer.NIPR.biographic:type_name -> producerflow.producer.v1.Producer.NIPR.Biographic
	113, // 95: producerflow.producer.v1.Producer.NIPR.regulatory_info:type_name -> producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo
	114, // 96: producerflow.producer.v1.Producer.NIPR.appointments:type_name -> producerflow.producer.v1.Producer.NIPR.Appointment
	...
	120, // 98: producerflow.producer.v1.Producer.NIPR.License.expiration_date:type_name -> google.protobuf.Timestamp
	120, // 99: producerflow.producer.v1.Producer.NIPR.License.updated_at:type_name -> google.protobuf.Timestamp
	115, // 100: producerflow.producer.v1.Producer.NIPR.License.lines_of_authority:type_name -> producerflow.producer.v1.Producer.NIPR.License.LineOfAuthority
	120, // 101: producerflow.producer.v1.Producer.NIPR.Biographic.date_of_birth:type_name -> google.protobuf.Timestamp
	117, // 102: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.regulatory_actions_by_state:type_name -> producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryActionsByStateEntry
	120, // 103: producerflow.producer.v1.Producer.NIPR.Appointment.status_reason_date:type_name -> google.protobuf.Timestamp
	120, // 104: producerflow.producer.v1.Producer.NIPR.Appointment.appointment_renewal_date:type_name -> google.protobuf.Timestamp
	120, // 105: producerflow.producer.v1.Producer.NIPR.License.LineOfAuthority.issue_date:type_name -> google.protobuf.Timestamp
	120, // 106: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryAction.date_of_action:type_name -> google.protobuf.Timestamp
	120, // 107: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryAction.effective_date:type_name -> google.protobuf.Timestamp
	120, // 108: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryAction.enter_date:type_name -> google.protobuf.Timestamp
	116, // 109: producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryActionsByStateEntry.value:type_name -> producerflow.producer.v1.Producer.NIPR.ProducerRegulatoryInfo.RegulatoryAction
	...
	10,  // 111: producerflow.producer.v1.ProducerService.CreateProducerOnboardingLink:input_type -> producerflow.producer.v1.CreateProducerOnboardingLinkRequest
	12,  // 112: producerflow.producer.v1.ProducerService.NewAgency:input_type -> producerflow.producer.v1.NewAgencyRequest
	60,  // 113: producerflow.producer.v1.ProducerService.ListOrganizations:input_type -> producerflow.producer.v1.ListOrganizationsRequest
	31,  // 114: producerflow.producer.v1.ProducerService.NewProducer:input_type -> producerflow.producer.v1.NewProducerRequest
	33,  // 115: producerflow.producer.v1.ProducerService.NewProducers:input_type -> producerflow.producer.v1.NewProducersRequest
	16,  // 116: producerflow.producer.v1.ProducerService.GetAgencyAndProducers:input_type -> producerflow.producer.v1.GetAgencyAndProducersRequest
	14,  // 117: producerflow.producer.v1.ProducerService.GetProducer:input_type -> producerflow.producer.v1.GetProducerRequest
	18,  // 118: producerflow.producer.v1.ProducerService.GetAgencyFiles:input_type -> producerflow.producer.v1.GetAgencyFilesRequest
	20,  // 119: producerflow.producer.v1.ProducerService.UpdateProducer:input_type -> producerflow.producer.v1.UpdateProducerRequest
	24,  // 120: producerflow.producer.v1.ProducerService.ApproveProducer:input_type -> producerflow.producer.v1.ApproveProducerRequest
	26,  // 121: producerflow.producer.v1.ProducerService.RejectProducer:input_type -> producerflow.producer.v1.RejectProducerRequest
	36,  // 122: producerflow.producer.v1.ProducerService.NewContact:input_type -> producerflow.producer.v1.NewContactRequest
	38,  // 123: producerflow.producer.v1.ProducerService.NewContacts:input_type -> producerflow.producer.v1.NewContactsRequest
	40,  // 124: producerflow.producer.v1.ProducerService.SetExternalID:input_type -> producerflow.producer.v1.SetExternalIDRequest
	42,  // 125: producerflow.producer.v1.ProducerService.ValidateProducerNPN:input_type -> producerflow.producer.v1.ValidateProducerNPNRequest
	44,  // 126: producerflow.producer.v1.ProducerService.ValidateAgencyNPN:input_type -> producerflow.producer.v1.ValidateAgencyNPNRequest
	46,  // 127: producerflow.producer.v1.ProducerService.LookupNPNByFEIN:input_type -> producerflow.producer.v1.LookupNPNByFEINRequest
	50,  // 128: producerflow.producer.v1.ProducerService.ResyncProducer:input_type -> producerflow.producer.v1.ResyncProducerRequest
	48,  // 129: producerflow.producer.v1.ProducerService.ResyncAgency:input_type -> producerflow.producer.v1.ResyncAgencyRequest
	52,  // 130: producerflow.producer.v1.ProducerService.SyncProducerWithNIPR:input_type -> producerflow.producer.v1.SyncProducerWithNIPRRequest
	54,  // 131: producerflow.producer.v1.ProducerService.SyncAgencyWithNIPR:input_type -> producerflow.producer.v1.SyncAgencyWithNIPRRequest
	56,  // 132: producerflow.producer.v1.ProducerService.StopSyncProducerWithNIPR:input_type -> producerflow.producer.v1.StopSyncProducerWithNIPRRequest
	58,  // 133: producerflow.producer.v1.ProducerService.StopSyncAgencyWithNIPR:input_type -> producerflow.producer.v1.StopSyncAgencyWithNIPRRequest
	63,  // 134: producerflow.producer.v1.ProducerService.CreateProducerUploadURL:input_type -> producerflow.producer.v1.CreateProducerUploadURLRequest
	66,  // 135: producerflow.producer.v1.ProducerService.AddAgencyLocations:input_type -> producerflow.producer.v1.AddAgencyLocationsRequest
	69,  // 136: producerflow.producer.v1.ProducerService.RemoveAgencyLocations:input_type -> producerflow.producer.v1.RemoveAgencyLocationsRequest
	71,  // 137: producerflow.producer.v1.ProducerService.ListAgencyLocations:input_type -> producerflow.producer.v1.ListAgencyLocationsRequest
	75,  // 138: producerflow.producer.v1.ProducerService.AssignProducerToLocations:input_type -> producerflow.producer.v1.AssignProducerToLocationsRequest
	77,  // 139: producerflow.producer.v1.ProducerService.UnassignProducerFromLocations:input_type -> producerflow.producer.v1.UnassignProducerFromLocationsRequest
	73,  // 140: producerflow.producer.v1.ProducerService.UpdateAgencyLocation:input_type -> producerflow.producer.v1.UpdateAgencyLocationRequest
	9,   // 141: producerflow.producer.v1.ProducerService.CreateAgencyOnboardingURL:output_type -> producerflow.producer.v1.CreateAgencyOnboardingURLResponse
	11,  // 142: producerflow.producer.v1.ProducerService.CreateProducerOnboardingLink:output_type -> producerflow.producer.v1.CreateProducerOnboardingLinkResponse
	13,  // 143: producerflow.producer.v1.ProducerService.NewAgency:output_type -> producerflow.producer.v1.NewAgencyResponse
	62,  // 144: producerflow.producer.v1.ProducerService.ListOrganizations:output_type -> producerflow.producer.v1.ListOrganizationsResponse
	32,  // 145: producerflow.producer.v1.ProducerService.NewProducer:output_type -> producerflow.producer.v1.NewProducerResponse
	34,  // 146: producerflow.producer.v1.ProducerService.NewProducers:output_type -> producerflow.producer.v1.NewProducersResponse
	17,  // 147: producerflow.producer.v1.ProducerService.GetAgencyAndProducers:output_type -> producerflow.producer.v1.GetAgencyAndProducersResponse
	15,  // 148: producerflow.producer.v1.ProducerService.GetProducer:output_type -> producerflow.producer.v1.GetProducerResponse
	19,  // 149: producerflow.producer.v1.ProducerService.GetAgencyFiles:output_type -> producerflow.producer.v1.GetAgencyFilesResponse
	21,  // 150: producerflow.producer.v1.ProducerService.UpdateProducer:output_type -> producerflow.producer.v1.UpdateProducerResponse
	25,  // 151: producerflow.producer.v1.ProducerService.ApproveProducer:output_type -> producerflow.producer.v1.ApproveProducerResponse
	27,  // 152: producerflow.producer.v1.ProducerService.RejectProducer:output_type -> producerflow.producer.v1.RejectProducerResponse
	37,  // 153: producerflow.producer.v1.ProducerService.NewContact:output_type -> producerflow.producer.v1.NewContactResponse
	39,  // 154: producerflow.producer.v1.ProducerService.NewContacts:output_type -> producerflow.producer.v1.NewContactsResponse
	41,  // 155: producerflow.producer.v1.ProducerService.SetExternalID:output_type -> producerflow.producer.v1.SetExternalIDResponse
	43,  // 156: producerflow.producer.v1.ProducerService.ValidateProducerNPN:output_type -> producerflow.producer.v1.ValidateProducerNPNResponse
	45,  // 157: producerflow.producer.v1.ProducerService.ValidateAgencyNPN:output_type -> producerflow.producer.v1.ValidateAgencyNPNResponse
	47,  // 158: producerflow.producer.v1.ProducerService.LookupNPNByFEIN:output_type -> producerflow.producer.v1.LookupNPNByFEINResponse
	51,  // 159: producerflow.producer.v1.ProducerService.ResyncProducer:output_type -> producerflow.producer.v1.ResyncProducerResponse
	49,  // 160: producerflow.producer.v1.ProducerService.ResyncAgency:output_type -> producerflow.producer.v1.ResyncAgencyResponse
	53,  // 161: producerflow.producer.v1.ProducerService.SyncProducerWithNIPR:output_type -> producerflow.producer.v1.SyncProducerWithNIPRResponse
	55,  // 162: producerflow.producer.v1.ProducerService.SyncAgencyWithNIPR:output_type -> producerflow.producer.v1.SyncAgencyWithNIPRResponse
	57,  // 163: producerflow.producer.v1.ProducerService.StopSyncProducerWithNIPR:output_type -> producerflow.producer.v1.StopSyncProducerWithNIPRResponse
	59,  // 164: producerflow.producer.v1.ProducerService.StopSyncAgencyWithNIPR:output_type -> producerflow.producer.v1.StopSyncAgencyWithNIPRResponse
	64,  // 165: producerflow.producer.v1.ProducerService.CreateProducerUploadURL:output_type -> producerflow.producer.v1.CreateProducerUploadURLResponse
	68,  // 166: producerflow.producer.v1.ProducerService.AddAgencyLocations:output_type -> producerflow.producer.v1.AddAgencyLocationsResponse
	70,  // 167: producerflow.producer.v1.ProducerService.RemoveAgencyLocations:output_type -> producerflow.producer.v1.RemoveAgencyLocationsResponse
	72,  // 168: producerflow.producer.v1.ProducerService.ListAgencyLocations:output_type -> producerflow.producer.v1.ListAgencyLocationsResponse
	76,  // 169: producerflow.producer.v1.ProducerService.AssignProducerToLocations:output_type -> producerflow.producer.v1.AssignProducerToLocationsResponse
	78,  // 170: producerflow.producer.v1.ProducerService.UnassignProducerFromLocations:output_type -> producerflow.producer.v1.UnassignProducerFromLocationsResponse
	74,  // 171: producerflow.producer.v1.ProducerService.UpdateAgencyLocation:output_type -> producerflow.producer.v1.UpdateAgencyLocationResponse
...
func file_producerflow_producer_v1_producer_proto_init() {
	...
	file_producerflow_producer_v1_producer_proto_msgTypes[15].OneofWrappers = []any{}
