...
func (x *ListAppointmentsRequest) GetPagination() *v1.Pagination {
	if x != nil {
		return x.Pagination
	}
	return nil
...
const file_producerflow_appointment_v1_appointment_proto_rawDesc = "" +
	"\n" +
	"-producerflow/appointment/v1/appointment.proto\x12\x1bproducerflow.appointment.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\x1a'producerflow/producer/v1/producer.proto\"m\n" +
	...
	"\vappointment\x18\x01 \x01(\v2(.producerflow.appointment.v1.AppointmentR\vappointment\"\x88\x03\n" +
	...
	"\x12operational_status\x18\x04 \x03(\x0e2..producerflow.appointment.v1.OperationalStatusR\x11operationalStatus\x12D\n" +
	"\n" +
	"pagination\x18\x05 \x01(\v2$.producerflow.producer.v1.PaginationR\n" +
	"paginationB\x16\n" +
...
var file_producerflow_appointment_v1_appointment_proto_goTypes = []any{
	...
	(*v1.Pagination)(nil),                  // 27: producerflow.producer.v1.Pagination
...
var file_producerflow_appointment_v1_appointment_proto_depIdxs = []int32{
	...
	27, // 4: producerflow.appointment.v1.ListAppointmentsRequest.pagination:type_name -> producerflow.producer.v1.Pagination
	23, // 5: producerflow.appointment.v1.ListAppointmentsResponse.appointments:type_name -> producerflow.appointment.v1.Appointment
	4,  // 6: producerflow.appointment.v1.TerminateAppointmentRequest.reason:type_name -> producerflow.appointment.v1.TerminationReason
	24, // 7: producerflow.appointment.v1.ListEligibleLicensesResponse.licenses:type_name -> producerflow.appointment.v1.License
	21, // 8: producerflow.appointment.v1.GetAppointableCarriersResponse.carriers:type_name -> producerflow.appointment.v1.Carrier
	0,  // 9: producerflow.appointment.v1.AppointmentOperationalStatus.status:type_name -> producerflow.appointment.v1.OperationalStatus
	1,  // 10: producerflow.appointment.v1.AppointmentOperationalStatus.risk_reasons:type_name -> producerflow.appointment.v1.RiskReason
	28, // 11: producerflow.appointment.v1.AppointmentOperationalStatus.last_updated:type_name -> google.protobuf.Timestamp
	24, // 12: producerflow.appointment.v1.Appointment.license:type_name -> producerflow.appointment.v1.License
	3,  // 13: producerflow.appointment.v1.Appointment.appointment_type:type_name -> producerflow.appointment.v1.AppointmentType
	2,  // 14: producerflow.appointment.v1.Appointment.processing_status:type_name -> producerflow.appointment.v1.ProcessingStatus
	28, // 15: producerflow.appointment.v1.Appointment.effective_date:type_name -> google.protobuf.Timestamp
	28, // 16: producerflow.appointment.v1.Appointment.termination_date:type_name -> google.protobuf.Timestamp
	28, // 17: producerflow.appointment.v1.Appointment.updated_at:type_name -> google.protobuf.Timestamp
	22, // 18: producerflow.appointment.v1.Appointment.operational_status:type_name -> producerflow.appointment.v1.AppointmentOperationalStatus
	29, // 19: producerflow.appointment.v1.License.expiration_date:type_name -> google.type.Date
	29, // 20: producerflow.appointment.v1.License.issue_date:type_name -> google.type.Date
	4,  // 21: producerflow.appointment.v1.ListTerminationReasonsResponse.termination_reasons:type_name -> producerflow.appointment.v1.TerminationReason
	7,  // 22: producerflow.appointment.v1.AppointmentService.GetAppointment:input_type -> producerflow.appointment.v1.GetAppointmentRequest
	15, // 23: producerflow.appointment.v1.AppointmentService.GetAppointmentFees:input_type -> producerflow.appointment.v1.GetAppointmentFeesRequest
	19, // 24: producerflow.appointment.v1.AppointmentService.GetAppointableCarriers:input_type -> producerflow.appointment.v1.GetAppointableCarriersRequest
	17, // 25: producerflow.appointment.v1.AppointmentService.GetTerminationFees:input_type -> producerflow.appointment.v1.GetTerminationFeesRequest
	9,  // 26: producerflow.appointment.v1.AppointmentService.ListAppointments:input_type -> producerflow.appointment.v1.ListAppointmentsRequest
	13, // 27: producerflow.appointment.v1.AppointmentService.ListEligibleLicenses:input_type -> producerflow.appointment.v1.ListEligibleLicensesRequest
	5,  // 28: producerflow.appointment.v1.AppointmentService.RequestAppointment:input_type -> producerflow.appointment.v1.RequestAppointmentRequest
	11, // 29: producerflow.appointment.v1.AppointmentService.TerminateAppointment:input_type -> producerflow.appointment.v1.TerminateAppointmentRequest
	25, // 30: producerflow.appointment.v1.AppointmentService.ListTerminationReasons:input_type -> producerflow.appointment.v1.ListTerminationReasonsRequest
	8,  // 31: producerflow.appointment.v1.AppointmentService.GetAppointment:output_type -> producerflow.appointment.v1.GetAppointmentResponse
	16, // 32: producerflow.appointment.v1.AppointmentService.GetAppointmentFees:output_type -> producerflow.appointment.v1.GetAppointmentFeesResponse
	20, // 33: producerflow.appointment.v1.AppointmentService.GetAppointableCarriers:output_type -> producerflow.appointment.v1.GetAppointableCarriersResponse
	18, // 34: producerflow.appointment.v1.AppointmentService.GetTerminationFees:output_type -> producerflow.appointment.v1.GetTerminationFeesResponse
	10, // 35: producerflow.appointment.v1.AppointmentService.ListAppointments:output_type -> producerflow.appointment.v1.ListAppointmentsResponse
	14, // 36: producerflow.appointment.v1.AppointmentService.ListEligibleLicenses:output_type -> producerflow.appointment.v1.ListEligibleLicensesResponse
	6,  // 37: producerflow.appointment.v1.AppointmentService.RequestAppointment:output_type -> producerflow.appointment.v1.RequestAppointmentResponse
	12, // 38: producerflow.appointment.v1.AppointmentService.TerminateAppointment:output_type -> producerflow.appointment.v1.TerminateAppointmentResponse
	26, // 39: producerflow.appointment.v1.AppointmentService.ListTerminationReasons:output_type -> producerflow.appointment.v1.ListTerminationReasonsResponse
